...
public class FormatTwosComplementOpExpressionTests extends RiverAssertions {

    @Test
    public void parseASingleTwoConstantInt32Expression() {
//        Expression exp = new BinaryOp( new ConstantInt32(1), BinaryOpEnum.TWOS_COMPLEMENT, new ConstantInt32(2) );
//
//        List<String> expectedRiverCode = Arrays.asList( "~2" );
//        List<String> expectedJavaCode  = Arrays.asList( "~2" );
//
