...
public class FormatLeftBitShiftOpExpressionTests extends RiverAssertions {

    @Test
    public void parseASingleTwoConstantInt32Expression() {
        Expression exp = new BinaryOp( new ConstantInt32(1), BinaryOpEnum.LEFT_BITSHIFT, new ConstantInt32(2) );
