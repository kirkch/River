...
public class FormatBitwiseExclusiveOrOpExpressionTests extends RiverAssertions {

    @Test
    public void parseASingleTwoConstantInt32Expression() {
        Expression exp = new BinaryOp( new ConstantInt32(1), BinaryOpEnum.BITWISE_EXCLUSIVE_OR, new ConstantInt32(2) );
