...
public class FormatZeroFillRightShiftOpExpressionTests extends RiverAssertions {

    @Test
    public void parseASingleTwoConstantInt32Expression() {
        Expression exp = new BinaryOp( new ConstantInt32(1), BinaryOpEnum.ZEROFILL_RIGHT_BITSHIFT, new ConstantInt32(2) );
